...
Aim for ANOVAs for significance, but also check on non-independence within reaches by running a mixed effects model


Ordination is the visualization of beta diversity
Adonis is effectively a PERMANOVA to check for significance of beta diversity
